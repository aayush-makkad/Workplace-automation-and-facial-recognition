...
public class Fan extends AppCompatActivity implements View.OnClickListener {
...
//                    finalText += text;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.button3 : connectSocket("on fan"); break;
            case R.id.button2 : connectSocket("dim"); break;
        }
    }
}
